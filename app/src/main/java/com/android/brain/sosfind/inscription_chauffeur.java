...
public class inscription_chauffeur extends AppCompatActivity implements View.OnClickListener {
    ...
    // Procedures
    private void register_chauffeurs(final CChauffeur ch) {
        try {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                map_chauff.put("vehicule", ch.getPlaque());
                                map_chauff.put("status", ch.getStatus());
                                map_chauff.put("image", ch.getImage());
                                ...
                                base.setValue(map_chauff).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            mprogress.dismiss();
                                            Toast.makeText(inscription_chauffeur.this, "Compte créé", Toast.LENGTH_LONG).show();
                                            startActivity(new Intent(inscription_chauffeur.this, login_chauff.class)
                                ...
                                mprogress.hide();
                                Toast.makeText(inscription_chauffeur.this, "Echec de création du compte",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SOS Agent Registration");
            ...
            switch (v.getId()) {
                case R.id.btn_inscr_chauff:
                    ...
                    if (!TextUtils.isEmpty(etMail.getText().toString()) && !TextUtils.isEmpty(etPass.getText().toString())
                        ...
                        chauffeur.setPlaque(etVehicule.getText().toString());
                        chauffeur.setLatiude("" + lat);
                        chauffeur.setLontitude("" + longs);
                        chauffeur.setImage("Default");
                        ...
                        mprogress.show();
                        register_chauffeurs(chauffeur);
                    } else {
                        Toast.makeText(inscription_chauffeur.this, "Complete all field", Toast.LENGTH_LONG).show();
                    }
                    break;
            }
        } catch (Exception ex) {
